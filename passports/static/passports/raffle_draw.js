(function () {
  ...
  // before the animation even starts; it's just the show. --------
  var POCKET_COUNT = 24;
  // Yellow / black (the charity's choice over classic red / black). The
  // rim and pointer colour lives in raffle_draw.html's --wheel-yellow.
  var POCKET_COLORS = ['#FFD100', '#111111'];
